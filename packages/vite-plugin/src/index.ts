...
export interface NapiMacrosPluginOptions {
  ...
  typeGenStrategy?: 'module-augmentation' | 'ambient' // How to generate types (default: 'module-augmentation')
}
...
function napiMacrosPlugin(options: NapiMacrosPluginOptions = {}): Plugin {
  ...
  function extractDecoratedClasses(code: string): Array<{ className: string; features: string[] }> {
    const classes: Array<{ className: string; features: string[] }> = []
  ...
  function generateTypeDef(className: string, features: string[]): string {
